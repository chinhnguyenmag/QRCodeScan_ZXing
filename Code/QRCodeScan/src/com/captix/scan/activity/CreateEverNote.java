 ...
 * 
 * @author baonguyen
 * @Description This sample shows how to list Evernote notebooks and create a
 *              note in the specific notebook.
 */
public class CreateEverNote extends ParentActivity {
